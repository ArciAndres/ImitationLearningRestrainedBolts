...
def parse_args():
    ...
    parser.add_argument("--brick-reward", type=int, default=100, help="The reward for breaking a brick.")
    parser.add_argument("--step-reward", type=float, default=-0.01, help="The reward for breaking a brick.")
    parser.add_argument("--goal-reward", type=int, default=10000, help="The reward for satisfying the temporal goal.")
